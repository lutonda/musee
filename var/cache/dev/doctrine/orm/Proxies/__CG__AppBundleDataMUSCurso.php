 ...
 */
class Curso extends \AppBundle\Data\MUS\Curso implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Data\\MUS\\Curso' . "\0" . 'id', '' . "\0" . 'AppBundle\\Data\\MUS\\Curso' . "\0" . 'nome', '' . "\0" . 'AppBundle\\Data\\MUS\\Curso' . "\0" . 'descricao'];
        }
