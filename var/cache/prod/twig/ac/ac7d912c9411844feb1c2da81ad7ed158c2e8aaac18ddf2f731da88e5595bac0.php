...
class __TwigTemplate_fec94c0bd3e37593b4927e8b3ebc1c381fdc46a567eec70193d5edd403877a32 extends Twig_Template
{
    ...
    <table>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["categorium"]) {
            ...
            echo "</a></td>
                <td>";
            // line 18
            echo twig_escape_filter($this->env, $this->getAttribute($context["categorium"], "nome", array()), "html", null, true);
            echo "</td>
                <td>
                    <ul>
                        <li>
...
";
    ...
    {
        return new Twig_Source("", ":categoria:index.html.twig", "/opt/lampp/htdocs/musee/des/app/Resources/views/categoria/index.html.twig");
    }
}
