...
class __TwigTemplate_4a860e0ca86022ce24e8de7ef35fb29af91109330b1c869416641d0f23486a6f extends Twig_Template
{
    ...
    <table>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["grupo"]) {
            ...
            echo "\">";
            echo twig_escape_filter($this->env, $this->getAttribute($context["grupo"], "id", array()), "html", null, true);
            echo "</a></td>
                <td>";
            // line 19
            echo twig_escape_filter($this->env, $this->getAttribute($context["grupo"], "nome", array()), "html", null, true);
            echo "</td>
                <td>";
            // line 20
...
";
    ...
    {
        return new Twig_Source("", ":grupo:index.html.twig", "/opt/lampp/htdocs/musee/des/app/Resources/views/grupo/index.html.twig");
    }
}
